      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="max-w-4xl mx-auto text-center space-y-12">
          ...
          <div className="space-y-4">
            <h3 className="text-herbal font-outfit font-bold tracking-[0.2em] uppercase text-xs sm:text-sm flex items-center justify-center gap-2">
              <FaShieldAlt className="text-gold" />
              પ્રમાણિત અને 100% સુરક્ષિત
            </h3>
            <h2 className="text-2xl sm:text-4xl font-extrabold text-stone-900 leading-tight font-heading">
              ગુજરાત સરકાર દ્વારા માન્યતા પ્રાપ્ત <br className="hidden sm:block" />
              <span className="text-gold">(Weight Control Product)</span>
            </h2>
          </div>

          <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center pt-4">
            ...
            <div className="relative group">
              ...
              <div className="relative bg-white p-3 rounded-2xl shadow-xl overflow-hidden border border-stone-100">
                <img 
              ...
              <p className="mt-4 text-stone-600 font-bold font-outfit flex items-center justify-center gap-2">
            ...
            <div className="relative group">
              ...
              <div className="relative bg-white p-3 rounded-2xl shadow-xl overflow-hidden border border-stone-100 flex items-center justify-center min-h-[300px]">
                <img 
