  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center bg-white pt-20">
      <div className="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          <span className="text-gold font-poppins font-semibold tracking-wider uppercase text-sm">
            AAYURVED NA AANGNE
          </span>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-gray-900">
            આયુર્વેદ દ્વારા કુદરતી રીતે <span className="text-herbal">વજન ઘટાડો</span>
          </h1>
          ...
          <div className="pt-4 flex flex-col sm:flex-row gap-4">
            <a
              ...
              target="_blank"
              className="btn btn-lg bg-herbal text-white border-none hover:bg-green-800 rounded-full px-8 flex items-center gap-3 w-fit shadow-lg shadow-herbal/30"
            >
            ...
            <a
              ...
              target="_blank"
              className="btn btn-lg bg-white text-herbal border border-herbal hover:bg-beige rounded-full px-8 flex items-center gap-3 w-fit shadow-md"
            >
              <Users size={24} />
              Join Group for Tips
            </a>
        ...
        <motion.div
          ...
          className="relative h-[500px] w-full mt-10 md:mt-0"
        >
