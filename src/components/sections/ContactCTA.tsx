            ...
            <div className="md:col-span-3 p-10 md:p-14 flex flex-col justify-center">
              ...
              >
                ...
                <ul className="space-y-4 mb-10">
                  {['કાયમી વજન ઘટાડો', 'કોઈ સાઇડ ઇફેક્ટ નથી', '100% આયુર્વેદિક પ્રોડક્ટ'].map((item, i) => (
                    <li key={i} className="flex items-center text-gray-700">
                      <CheckCircle2 className="text-herbal mr-3" size={20} />
                ...
                <a
                  ...
                  target="_blank"
                  className="group relative inline-flex items-center justify-center px-8 py-4 font-bold text-white bg-green-500 rounded-full overflow-hidden shadow-lg shadow-green-500/40 hover:shadow-green-500/60 hover:scale-105 transition-all duration-300"
                >
                  ...
                  <MessageCircle className="relative mr-3" size={24} />
                  <span className="relative text-lg border-l border-white/30 pl-3">હમણાં WhatsApp પર સંપર્ક કરો</span>
                </a>
              </motion.div>
            </div>
            
            <div className="md:col-span-2 bg-herbal p-10 flex flex-col justify-center text-white relative overflow-hidden">
