...
export const WhatsAppButton = ({ text = "અત્યારે જ ઓર્ડર કરો", message = "Hello, I want to order Hair Care products", className = "" }: { text?: string; message?: string; className?: string }) => (
