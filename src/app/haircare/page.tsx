    ...
    <main className="bg-[#FAFAF9] min-h-screen overflow-x-hidden">
      ...
      <Section className="bg-white rounded-3xl my-12 border border-stone-100 shadow-sm text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-min">
          ...
          <img src={haircareResults.img1} alt="Result 1" className="w-full rounded-xl shadow-md h-auto" />
          <img src={haircareResults.img2} alt="Result 2" className="w-full rounded-xl shadow-md h-auto" />
          <img src={haircareResults.img3} alt="Result 3" className="w-full rounded-xl shadow-md h-auto" />
